  ...
  amenities: [
    {
      ...
      items: [
        ...
        { name: "Competition Squash Court", schemaName: "squashCourt" },
        {
          name: "Full Size Pickleball Court (coming soon)",
          schemaName: "pickleballCourt",
        },
        { name: "Integrated Audio System", schemaName: "soundSystem" },
        { name: "Game Room with Pool Table", schemaName: "poolTable" },
        { name: "Professional Table Tennis", schemaName: "tableTennis" },
        {
          name: "Walleyball & Volleyball Court",
          schemaName: "volleyballCourt",
        },
        { name: "Mini Padel Court", schemaName: "padelCourt" },
        { name: "Mini Pickleball Court", schemaName: "pickleballCourt" },
        {
          name: "Premium Entertainment System with Multiple Large-Screen TVs",
          schemaName: "television",
        },
        { name: "Curated Board Game Collection", schemaName: "boardGames" },
        { name: "Private Library & Reading Nook", schemaName: "library" },
      ],
    },
    {
      ...
      items: [
        {
          name: "Direct Ski-In Access to Fernie Alpine Resort",
        ...
        {
          name: "Temperature-Controlled Ski Locker & Boot Room",
          schemaName: "skiStorage",
        },
        { name: "Heated Two-Car Private Garage", schemaName: "parking" },
        { name: "Premium Outdoor Gas BBQ", schemaName: "barbecue" },
        {
          name: "Wraparound Covered Terraces & Balconies",
          schemaName: "patio",
        },
        { name: "Al Fresco Dining Terrace", schemaName: "outdoorDining" },
        {
          name: "Designer Outdoor Furnishings",
          schemaName: "outdoorFurniture",
        },
      ],
    },
    {
      ...
      items: [
        ...
        { name: "Climate-Controlled Wine Cellar", schemaName: "wineFridge" },
        {
          name: "Grand Dining Table Seating Twelve",
        ...
        {
          name: "Professional Gas Range & Convection Oven",
          schemaName: "stove",
        },
        { name: "Espresso & Coffee Bar", schemaName: "coffeeMaker" },
        { name: "Electric Kettle", schemaName: "kettle" },
        { name: "Artisan Toaster", schemaName: "toaster" },
        { name: "High-Performance Blender", schemaName: "blender" },
        { name: "Built-In Trash Compactor", schemaName: "trashCompactor" },
      ],
    },
    {
      ...
      items: [
        ...
        { name: "Central Climate Control", schemaName: "airConditioning" },
        ...
        { name: "Executive Home Office", schemaName: "workspace" },
    ...
    },
    {
      ...
      items: [
        ...
        {
          name: "Children's Library & Toy Collection",
    ...
    },
    {
      ...
      items: [
        ...
        { name: "Comprehensive First Aid Station", schemaName: "firstAidKit" },
        {
          name: "24/7 Exterior Security Surveillance",
          schemaName: "securityCameras",
        },
        {
          name: "Advanced Noise Monitoring System",
